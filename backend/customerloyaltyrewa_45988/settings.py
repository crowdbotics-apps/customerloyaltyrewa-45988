"""
Django settings for customerloyaltyrewa_45988 project.
...
ROOT_URLCONF = 'customerloyaltyrewa_45988.urls'
...
WSGI_APPLICATION = 'customerloyaltyrewa_45988.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "customerloyaltyrewa_45988 API",
    "DESCRIPTION": "API documentation for customerloyaltyrewa_45988 App",
    "VERSION": "v1",
}
